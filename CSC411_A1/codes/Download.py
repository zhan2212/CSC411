# -*- coding: utf-8 -*-
"""
Created on Sun Jan 21 16:13:53 2018
...
for a in act:
    ...
    for line in open(dirpath + "/facescrub_actors.txt"):
        if a in line:
            ...
            if os.path.exists(dirpath + "/uncropped/"+filename):
                print("skip")
                continue
            ...
            try:
                ...
                img = imresize(cropped,(227,227))
                imsave(dirpath + "/croppedA2/"+filename,img)
                print("x")
