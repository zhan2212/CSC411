...
# -*- coding: utf-8 -*-
"""
Created on Fri Feb 23 07:36:41 2018
...
dataloader = DataLoader(trainDataset, batch_size=1024, shuffle=True, num_workers=0)
...
#plt.legend(handles = ['trainPerformance','valiPerformance', 'testPerformance'])
plt.show()
